...
class MultiAgent(BaseMultiAgent):
    ...
    Workflow:
        Planner → Researcher → Summarizer → Solver → Evaluator
    ...
    def _build_graph(self) -> StateGraph:
        ...
        # Linear flow: Planner → Researcher → Summarizer → Solver → Evaluator
        ...
        # Conditional feedback loop: Evaluator → Planner or END
...
Instructions:
- Break the work into 3–6 clear bullet points.
